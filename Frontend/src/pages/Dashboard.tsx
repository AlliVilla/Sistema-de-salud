...
export default function Dashboard({
  ...
  const isConnecting =
    btState === "connecting" || btState === "scanning" || connectingId !== null
  const stateDotColor = isConnected
    ? theme.colors.green
    : btState === "error"
      ? theme.colors.danger
      : isConnecting
        ...
        : "#3E5652"
  const stateLabel =
    isConnected && connectedName ? connectedName : "Sin dispositivo"
          ...
          <div style={{ display: "flex", alignItems: "center", gap: 12 }}>
            <div style={{ position: "relative", flexShrink: 0 }}>
              <div
                ...
                className={isConnecting && !connectingId ? "blink" : ""}
              />
            </div>
            <div style={{ flex: 1, minWidth: 0 }}>
              ...
              <div
                style={{
                  fontSize: 11,
                  color: isConnected ? theme.colors.green : theme.colors.muted,
                }}
              >
                {stateSub}
              </div>
        ...
        {modalOpen && (
          ...
          >
            ...
            >
              ...
              {/* Device list */}
              <div
                style={{ flex: 1, overflow: "auto", padding: "8px 20px 16px" }}
              >
                {knownDevices.length === 0 ? (
                  <div
                    style={{
                    ...
                    {knownDevices.map((device) => {
                      ...
                      return (
                        <div
                          key={device.id}
                          onClick={() =>
                            !isThisConnected && handleDevicePick(device)
                          }
                          style={{
                            borderRadius: 12,
                            background: isThisConnected
                          ...
                          >
                            ...
                            >
                              <svg
                                ...
                                viewBox="0 0 24 24"
                                fill="none"
                                stroke={isThisConnected ? "#34D399" : "#2DD4BF"}
                                strokeWidth="2"
                                strokeLinecap="round"
                              ...
                              {!isThisConnected && !isThisConnecting && (
                                <span
                                  style={{
                                    ...
                                    padding: "1px 6px",
                                    borderRadius: 6,
                                    background: device.inRange
                                      ? "rgba(52,211,153,0.12)"
                                      : "rgba(127,160,156,0.08)",
                                    color: device.inRange
                                      ? theme.colors.green
                                      : "#3E5652",
                                    border: `1px solid ${
                                      device.inRange
                                        ? "rgba(52,211,153,0.2)"
                                        : "rgba(127,160,156,0.1)"
                                    }`,
                                  }}
                                >
                                  {device.inRange
        ...
        >
          ...
          >
            ...
            >
              ...
              <div
                ...
                style={{
                  ...
                  height: 7,
                  borderRadius: "50%",
                  background: hrLive ? theme.colors.green : theme.colors.danger,
                }}
              />
            </div>
            <div
              className="font-mono heartbeat"
              style={{
                fontSize: 36,
                fontWeight: 600,
            ...
            <div
              style={{
                fontSize: 11,
                color: hrLive ? theme.colors.green : theme.colors.muted,
              }}
            >
          ...
          >
            ...
            >
              ...
              <div
                style={{
                  ...
                  height: 7,
                  borderRadius: "50%",
                  background: spo2Live ? theme.colors.green : theme.colors.teal,
                }}
              />
            </div>
            <div
            ...
            <div
              style={{
                fontSize: 11,
                color: spo2Live ? theme.colors.green : theme.colors.muted,
              }}
            >
              % saturación
            </div>
